...
namespace NuggetOfficial.Actions
{
	...
	{
		public static async Task TrackMemberJoinGuild(DiscordClient member, GuildMemberAddEventArgs args)
		{
			/*See if this member exists in the tracked information and perform an action if they violated a rule*/
			await Task.CompletedTask;
		}

		public static async Task TrackMemberLeaveGuild(DiscordClient member, GuildMemberRemoveEventArgs args)
		{
